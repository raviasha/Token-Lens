...
def build_feedback(records, session_id):
    ...
    prompt_status = health_status(interventions, "promptReviewer", "prompt.reviewed", "code-buddy_reviewPrompt")
    scope_status = health_status(interventions, "taskDecomposer", "task.decomposition_evaluated", "code-buddy_decomposeTask")
    context_status = health_status(interventions, "contextMeasurement", "context.measured", "code-buddy_measureContext")
    session_fit_status = health_status(interventions, "sessionFit", "session.fit_evaluated", "code-buddy_assessSessionFit")
    updated = now_iso()
    lines = [
        "# Code Buddy",
        "",
