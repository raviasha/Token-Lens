...
function getSettings(root: vscode.Uri): HookSettings & { logPath: string; feedbackPath: string; analyticsPath: string } {
...
function createHookEntry(
  ...
  root: vscode.Uri,
  settings: HookSettings & { logPath: string; feedbackPath: string; analyticsPath: string }
): HookValue {
  return {
    type: 'command',
